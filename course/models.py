...
class ElectronicResource(models.Model):
    """General-purpose electronic library item available to students and lecturers."""
    ...
    file = models.FileField(
        ...
        help_text=_("Upload a document or archive. Leave empty if you only provide a link."),
    )
    link = models.URLField(blank=True, help_text=_("Optional external link to the resource."))
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

    class Meta:
        ordering = ("-created_at",)
        verbose_name = _("Electronic Resource")
        verbose_name_plural = _("Electronic Resources")
    ...
    def clean(self):
        ...
        if not self.file and not self.link:
            raise ValidationError(_("Provide either a file or a link for the resource."))
