...
from result.views import TakenCourse
...
class Program(models.Model):
    ...
    course = models.ForeignKey(Course, on_delete=models.CASCADE, related_name="program_course")
...
class ProgramCode(models.Model):
    ...
    grade = models.ForeignKey(TakenCourse, on_delete=models.PROTECT, null=True, blank=True, related_name='programs')
