...
urlpatterns = [
    ...
    path("<slug>/programs/", views.program_list, name="program_index"),

    # MY
    path("execute/<int:pk>/", views.execute_python_code, name="execute_python_code"),
    path("code-editor/<int:pk>", views.code_editor, name="code_editor"),
    path("check/<int:pk>", views.check_program_student, name="check_student_program_list"),
    path("check_detail/<int:pk>", views.detail_check_code, name="check_student_program"),
    #path("<slug>/program_add/", views.QuizCreateView.as_view(), name="quiz_create"),
